...
public class OfflineCartViewAdapter extends RecyclerView.Adapter<OfflineCartViewAdapter.CartViewHolder> {
    private List<CartDBModel> cartResponseList;
    private Context context;
    private ItemClickListener mClickListener;

    public OfflineCartViewAdapter(Context context) {
        this.context = context;
    }

    public void setData(List<CartDBModel> cartResponseList) {
    ...
    public void onBindViewHolder(@NonNull CartViewHolder holder, int position) {
        CartDBModel cartKeyResponse = cartResponseList.get(position);
